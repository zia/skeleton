...
$to_be_stored = $target.'modules/'.$c.'/controllers';
if (!file_exists($to_be_stored)) {
    mkdir($to_be_stored, 0777, true);
}


$hasil_controller = createFile($string, $to_be_stored . "/" . $c_file);
