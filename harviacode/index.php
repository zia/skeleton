...
<html>
    ...
    <body>
        <div class="row">
            <div class="col-md-3" style="border-right:1px solid #000;height:1270px;">
                ...
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        <label>Configure Route</label>
                        <input type="text" id="route" name="route" value="<?php echo isset($_POST['route']) ? $_POST['route'] : '' ?>" class="form-control" placeholder="Route Name" title="e.g. for UserController you mgit want to use 'user' route." disabled />
                    </div>
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">Codeigniter CRUD Generator 1.4 by Harviacode
                    <a href="http://<?=$_SERVER[HTTP_HOST].'/'.$fileName[1]?>" class="btn btn-primary"><span class="glyphicon glyphicon-home"></span> Home</a>
